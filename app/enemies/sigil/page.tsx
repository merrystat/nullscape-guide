          ...
          <article className="space-y-6">
            ...
            <div className="rounded-3xl border border-slate-200 bg-slate-50 p-6 shadow-sm">
              ...
              <ul className="mt-4 space-y-3 text-slate-700">
                <li>• 최소 레벨 20부터 등장합니다.</li>
                <li>• 선택 한도는 1이고 최대 스택은 2입니다.</li>
                <li>• 빔은 락온된 플레이어에게만 표시됩니다.</li>
                <li>• Sigil은 한 플레이어를 동시에 두 개 이상의 빔으로 락온하지 않습니다.</li>
                <li>• 죽으면 시체가 튕겨져 화염이 붙을 수 있습니다.</li>
                <li>• 관련 저주가 없습니다.</li>
              </ul>
            </div>
          </article>
