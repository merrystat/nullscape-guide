        ...
        <div className="grid gap-8 lg:grid-cols-[1.6fr_1fr]">
          <div>
            ...
            <div className="mt-4 flex justify-between">
              ...
              <a href="/enemies/springer" className="inline-flex items-center gap-2 rounded-full bg-slate-900 px-4 py-2 text-sm font-semibold text-white transition hover:bg-slate-800">Springer 페이지 →</a>
            </div>
          </div>
